...
## Location
The workshop and hackathon is located at Morgan Library on the second floor of the Kerckhoff building at Caltech. See map (click link for interactive map):
...
![Inside Morgan Library](https://kckarchitects.com/wp-content/uploads/2015/02/IMG_5794_hero.JPG.jpg)
...
| 10:30 - 11:30 am | Intro to spatial -omics technologies |
| 11:30 - 11:45 am | Break |
| 11:45 am - 12 pm | Overview of spatial data analysis methods |
| 12 pm - 1 pm | `SpatialFeatureExperiment` workshop |
| 1 - 1:45 pm | Lunch break, food provided |
...
```{r}
knitr::include_url("http://u.osmfr.org/m/993061/")
```
...
```{r}
knitr::include_url("http://u.osmfr.org/m/996975/")
```
