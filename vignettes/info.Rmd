...
In solidarity against occupation, colonization and the injustices inflicted on the First Nations, I acknowledge that this is the unceded territory of the Tongva/Kizh people who called this territory [Tonvaangar](https://tongva.land/). Caltech is near the village of Tobpet. Today, Tovaangar/much of the LA-OC-IE metropolitan area is still the home to many Indigenous people from across Turtle Island and we are grateful to have the opportunity to live and do research on this territory. Recognizing whose land we are on is a start but we cannot stop there. There can be no reconciliation without conciliation and there can be no conciliation without reparations. Those here who are not First Nations, must remember that they/we are guests on this land and need to be better guests. (Abridged from el-Tawhid Juma Circle)
